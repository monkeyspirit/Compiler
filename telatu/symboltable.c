...
void addLine(PLine l){
    ...
    if(1) // bisogna controllare se in symbolaTable[index] non c'è niente
        symbolTable[index] = l;
    else
        symbolTable[index]->next = l;
}
